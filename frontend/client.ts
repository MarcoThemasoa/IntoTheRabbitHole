...
export class Client {
    ...
    public readonly stories: stories.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.stories = new stories.ServiceClient(base)
    }
 ...
 */
import { getStats as api_analytics_stats_getStats } from "~backend/analytics/stats";
import { trackPageView as api_analytics_track_trackPageView } from "~backend/analytics/track";
...
export namespace analytics {
    ...
    export class ServiceClient {
         ...
         */
        public async getStats(): Promise<ResponseType<typeof api_analytics_stats_getStats>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/stats`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_stats_getStats>
        }

        /**
         * Records a page view in the analytics database.
         */
        public async trackPageView(params: RequestType<typeof api_analytics_track_trackPageView>): Promise<void> {
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_stories_create_create } from "~backend/stories/create";
import { list as api_stories_list_list } from "~backend/stories/list";
...
export namespace stories {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_stories_create_create>): Promise<ResponseType<typeof api_stories_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/stories`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_stories_create_create>
        }

        /**
         * Retrieves all approved stories, ordered by creation date.
         */
        public async list(): Promise<ResponseType<typeof api_stories_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/stories`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_stories_list_list>
        }
    }
}
