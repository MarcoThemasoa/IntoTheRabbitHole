...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-br from-sky-950 via-blue-900 to-sky-900 text-white mt-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="p-3 rounded-2xl bg-gradient-to-br from-sky-400 to-blue-600 shadow-xl">
          ...
          <div>
            ...
            <div className="space-y-3">
              <Link
                to="/"
                className="block text-sky-200 hover:text-white hover:translate-x-1 transform duration-200"
              >
                Beranda
              </Link>
              <Link
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center space-x-2 text-sky-200 hover:text-white transition-all group"
              >
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sky-200 text-sm">
              &copy; 2025 DeepfakeAware Indonesia. Semua hak dilindungi.
            </p>
            <p className="text-sky-200 text-sm">
